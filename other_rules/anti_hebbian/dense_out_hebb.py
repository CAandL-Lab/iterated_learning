...
if __name__ == "__main__":
  ...
  for k in range(sys_norms.shape[1]):
      if k == 0:
          plt.plot(sys_sys_norms[:,k], color='red', label=r'AH $\Omega_x\Omega_y\text{-Norm}$')
          plt.plot(non_sys_norms[:,k], color='blue', label=r'AH $\Gamma_x\Omega_y\text{-Norm}$')
          plt.plot(sys_non_norms[:,k], color='purple', label=r'AH $\Omega_x\Gamma_y\text{-Norm}$')
          plt.plot(non_non_norms[:,k], color='navy', label=r'AH $\Gamma_x\Gamma_y\text{-Norm}$')
  ...
  colours_arr = [('red','green',r'GD $\pi_1$', r'AH $\pi_1$'),('blue','orange',r'GD $\pi_2$', r'AH $\pi_2$'),
                 ('cyan','purple',r'GD $\pi_3$', r'AH $\pi_3$')]
