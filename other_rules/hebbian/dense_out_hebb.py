...
if __name__ == "__main__":
  ...
  for k in range(sys_norms.shape[1]):
      if k == 0:
          plt.plot(sys_sys_norms[:,k], color='red', label=r'Hebb $\Omega_x\Omega_y\text{-Norm}$')
          plt.plot(non_sys_norms[:,k], color='blue', label=r'Hebb $\Gamma_x\Omega_y\text{-Norm}$')
          plt.plot(sys_non_norms[:,k], color='purple', label=r'Hebb $\Omega_x\Gamma_y\text{-Norm}$')
          plt.plot(non_non_norms[:,k], color='navy', label=r'Hebb $\Gamma_x\Gamma_y\text{-Norm}$')
          plt.plot(preds_sys_sys_norms[:,k], color='green', Label=r'GD $\Omega_x\Omega_y\text{-Norm}$', linestyle='dashed')
          plt.plot(preds_non_sys_norms[:,k], color='orange', label=r'GD $\Gamma_x\Omega_y\text{-Norm}$', linestyle='dashed')
          plt.plot(preds_sys_non_norms[:,k], color='lime', Label=r'GD $\Omega_x\Gamma_y\text{-Norm}$', linestyle='dashed')
          plt.plot(preds_non_non_norms[:,k], color='cyan', label=r'GD $\Gamma_x\Gamma_y\text{-Norm}$', linestyle='dashed')
      else:
  ...
  colours_arr = [('red','green',r'GD $\pi_1$', r'Hebb $\pi_1$'),('blue','orange',r'GD $\pi_2$', r'Hebb $\pi_2$'),
                 ('cyan','purple',r'GD $\pi_3$', r'Hebb $\pi_3$')]
